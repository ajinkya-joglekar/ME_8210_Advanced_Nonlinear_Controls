...
'Left click to draw an orbit starting there, right click to save the phase potrait and quit.'

while 1,
        [x1,x2,button]=ginput(1);
        if button ~= 1 
            fig_name_str = strcat(string(fname),'_pp.png');
            saveas(gcf,fig_name_str)
            break; 
        end
